                ...
                <div class="card">
                        <div class="row">
                            ...
                            <div class="container-fluid"><br><br>
                                <img src="assets/img/indo.png" class="rounded float-center ml-5 mt-3" width="420px" alt="" >
                            </div>
                            </div>
                ...
                <div>
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active text-secondary" id="indo-tab" data-toggle="tab" href="#indo" role="tab" aria-controls="indo" aria-selected="true">Indomaret</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link text-secondary" id="isaku-tab" data-toggle="tab" href="#isaku" role="tab" aria-controls="isaku" aria-selected="false">i.Saku</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="indo" role="tabpanel" aria-labelledby="indo-tab"><br>
                            <h5>LANGKAH 1: PERGI KE INDOMARET TERDEKAT</h5><br>
                            <h4>
                            <small class="text-muted">
                                1. Sampaikan kepada kasir Indomaret untuk melakukan pembayaraan PintarIN <br><br>
                        ...
                        <div class="tab-pane fade" id="isaku" role="tabpanel" aria-labelledby="isaku-tab"><br>
                            <h5>LANGKAH 1: BUKA APLIKASI I.SAKU</h5><br>
                            <h4>
                            <small class="text-muted">
                                1. Pilih "Lihat Semua" dan pilih "Belanja Online" <br><br>
                                2. Pilih PintarIN sebagai Penyesia Layanan dan masukkan kode pembayaran. <br> Selanjutnya, klik "PROSES" <br>
                            </small>
                            </h4><br>
                            <h5>LANGKAH 2: TRANSAKSI BERHASIL</h5><br>
                            <h4>
